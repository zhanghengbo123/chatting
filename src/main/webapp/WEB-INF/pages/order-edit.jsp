                            ...
                            <form role="form" class="form-horizontal" method="POST" enctype="multipart/form-data"
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <%--<label class="col-sm-2 control-label" for="orderType">订单类型</label>--%>
                                        <%--<div class="col-sm-4">--%>
                                            <%--<select name="orderType" id="orderType" class="form-control">--%>
                                                <%--<c:forEach var="oType" items="${orderTypeMap}" varStatus="status">--%>
                                                    <%--<c:choose>--%>
                                                        <%--<c:when test="${oType.key eq order.orderType}">--%>
                                                ...
                                                <%--</c:forEach>--%>
                                            <%--</select>--%>
                                            <%--&lt;%&ndash;<input class="form-control" id="orderType" name="orderType" value="${order.orderType}" type="text" placeholder="订单类型"/>&ndash;%&gt;--%>
                                        <%--</div>--%>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name="unitPrice" id="unitPrice"
                                                   value="${order.unitPrice}" type="number" step="0.01" />
                                        </div>
                                        <label class="col-sm-2 control-label">收费单位</label>
                                        <div class="col-sm-4">
                                            <select name="priceType" id="priceType" class="form-control">
                                                <c:forEach var="pType" items="${priceTypeMap}" varStatus="status">
                                                    <c:choose>
                                                        <c:when test="${pType.key eq order.priceType}">
                                                            <option value="${pType.key}"
                                                                    selected>${pType.value}</option>
                                                        </c:when>
                                                        <c:otherwise>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="totalPrice">总价</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name="totalPrice" id="totalPrice"
                                                   value="${order.totalPrice}" type="number" step="0.01"/>
                                        </div>
                                        <label class="col-sm-2 control-label">代收货款</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name="payCount" id="payCount"
                                                   value="${order.payCount}" type="number" placeholder="代收货款"/>
                                        </div>
                                    </div>
